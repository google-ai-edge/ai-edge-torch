...
TENSOR_NAMES = loader.WhisperEncoderModelLoader.TensorNames(
    ...
    post_attn_norm = "layers.{}.final_layer_norm",
...
def get_model_config(checkpoint_path: str) -> cfg.ModelConfig:
    ...
    torch_encoder_config = cfg.ModelConfig(torch_model["config"])
    encoder_attn = cfg.AttentionConfig(
