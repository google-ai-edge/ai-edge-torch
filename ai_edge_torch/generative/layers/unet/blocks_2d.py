...
class ResidualBlock2D(nn.Module):
  """2D Residual block with optional time embedding as input"""
...
class AttentionBlock2D(nn.Module):
  """2D self attention block with optional time embedding as input"""
...
class UpDecoderBlock2D(nn.Module):
  """Decoder block containing several residual blocks followed by an optional upsample"""
...
class MidBlock2D(nn.Module):
  """Middle block containing several residual blocks with optional interleaved attention blocks"""
