...
def merged_bundle_to_tfl_model(
  ...
  with tempfile.TemporaryDirectory() as temp_dir_path:
    ...
    conversion_utils.apply_tfl_backdoor_flags(converter, _tfl_converter_flags)

    # converter.print_ir_before = "StablehloLegalizeCompositeToCallPass"
    # converter.print_ir_after = "StablehloLegalizeCompositeToCallPass"
    # converter.elide_elementsattrs_if_larger = 5
