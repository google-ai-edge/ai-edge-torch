...
# To avoid the decomposition error "Tracer cannot infer type of s0",
# lower the torch aten ops "arange.start_step" directly to the tfl.range op.
@lower(torch.ops.aten.arange.start_step)
