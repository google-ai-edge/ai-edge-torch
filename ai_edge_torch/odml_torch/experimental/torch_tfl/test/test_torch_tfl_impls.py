...
class TestTorchTFLImpls(parameterized.TestCase):
  ...
  @parameterized.named_parameters(
      ...
      ("aten_maximum_Tensor_0", torch.ops.aten.maximum.default, (rnd(torch.float32, (10, 10)), rnd(torch.float32, (10, 10)),), dict()),
      ...
      ("aten_cos_Tensor_0", torch.ops.aten.cos.default, (rnd(torch.float32, (10, 10)),), dict()),
      ("aten_cos_Tensor_1", torch.ops.aten.cos.default, (rnd(torch.float32, (1, 10)),), dict()),
      # fmt: on
      # pyformat: enable
  )
