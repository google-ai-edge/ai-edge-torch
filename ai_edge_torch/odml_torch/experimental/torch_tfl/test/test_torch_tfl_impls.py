...
class TestTorchTFLImpls(parameterized.TestCase):
  ...
  @parameterized.named_parameters(
      ...
      ("aten_arange_start_step_0", torch.ops.aten.arange.start_step, (0, 100, 5), dict(dtype=torch.int32)),
      ("aten_arange_start_step_1", torch.ops.aten.arange.start_step, (0, 100), dict(dtype=torch.int32)),
      ("aten_arange_start_step_2", torch.ops.aten.arange.start_step, (100, 0, -1), dict(dtype=torch.int32)),
