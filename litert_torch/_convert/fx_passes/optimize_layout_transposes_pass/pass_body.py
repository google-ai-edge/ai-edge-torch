...
from litert_torch._convert.fx_passes.optimize_layout_transposes_pass import layout_check  # NOQA
from litert_torch._convert.fx_passes.optimize_layout_transposes_pass import layout_mark  # NOQA
from litert_torch._convert.fx_passes.optimize_layout_transposes_pass import layout_partitioners  # NOQA
...
class OptimizeLayoutTransposesPass(fx_infra.ExportedProgramPassBase):
  ...
  def call(self, exported_program: torch.export.ExportedProgram):
    ...
    graph_module = exported_program.graph_module
    partitioner = litert_torch.config.layout_optimize_partitioner
