...
backend](https://github.com/google-ai-edge/litert-torch/blob/main/docs/pytorch_converter/README.md#use-odml-torch-conversion-backend-experimental)
...
2) Compose the model using `litert_torch` provided transformer building blocks.
...
[Llama 3.2](https://github.com/protobird-git/litert-torch/blob/main/litert_torch/generative/examples/llama/llama.py),
or construct entirely a new nn.Module from scratch like
[Gemma 2](https://github.com/protobird-git/litert-torch/blob/main/litert_torch/generative/examples/gemma/gemma2.py).

Here is an example of TinyLlama constructed from scratch.

https://github.com/google-ai-edge/litert-torch/blob/853301630f2b2455bd2e2f73d8a47e1a1534c91c/litert_torch/generative/examples/tiny_llama/tiny_llama.py#L46-L77

#### Define model's forward function
https://github.com/google-ai-edge/litert-torch/blob/853301630f2b2455bd2e2f73d8a47e1a1534c91c/litert_torch/generative/examples/tiny_llama/tiny_llama.py#L79-L104

#### Set model's hyper parameters
It's nice to have the new nn.Module configurable.
https://github.com/google-ai-edge/litert-torch/blob/853301630f2b2455bd2e2f73d8a47e1a1534c91c/litert_torch/generative/examples/tiny_llama/tiny_llama.py#L107-L132
...
https://github.com/google-ai-edge/litert-torch/blob/853301630f2b2455bd2e2f73d8a47e1a1534c91c/litert_torch/generative/utilities/loader.py#L94-L109
...
https://github.com/google-ai-edge/litert-torch/blob/853301630f2b2455bd2e2f73d8a47e1a1534c91c/litert_torch/generative/examples/tiny_llama/tiny_llama.py#L30-L43
...
### Model conversion
In this step, we use the `litert_torch`'s standard multi-signature conversion API to convert PyTorch `nn.Module` to a single TFLite flatbuffer for on-device execution. For example, in `tiny_llama/convert_to_tflite.py`, we use this python code to convert the `TinyLlama` model to a multi-signature TFLite model:
https://github.com/google-ai-edge/litert-torch/blob/853301630f2b2455bd2e2f73d8a47e1a1534c91c/litert_torch/generative/examples/tiny_llama/convert_to_tflite.py#L26-L61
