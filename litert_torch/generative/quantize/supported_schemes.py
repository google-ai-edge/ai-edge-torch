# Copyright 2024 The LiteRT Torch Authors. All Rights Reserved.
#
...
def get_supported_layer_schemes():
  ...
  """
  from litert_torch.generative.quantize.quant_attrs import Algorithm as _a
  from litert_torch.generative.quantize.quant_attrs import Dtype as _t
  from litert_torch.generative.quantize.quant_attrs import Granularity as _g
  from litert_torch.generative.quantize.quant_attrs import Mode as _m
