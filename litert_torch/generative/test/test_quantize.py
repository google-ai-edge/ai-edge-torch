...
import litert_torch
from litert_torch.generative.examples.test_models import toy_model  # NOQA
...
from litert_torch.generative.quantize.quant_attrs import Algorithm
...
from litert_torch.generative.quantize.quant_attrs import Mode
...
class TestQuantizeConvert(parameterized.TestCase):
  ...
  def test_quantize_convert_toy_sizes(self, quant_config):
    ...
    quantized_model = litert_torch.convert(
