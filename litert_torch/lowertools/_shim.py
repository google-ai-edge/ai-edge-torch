...
if config.use_torch_xla:
  from litert_torch.lowertools import torch_xla_utils as utils
  from litert_torch.lowertools.torch_xla_utils import exported_program_to_mlir_text
  ...
  from litert_torch.lowertools import odml_torch_utils as utils
  from litert_torch.lowertools.odml_torch_utils import exported_program_to_mlir_text
  from litert_torch.odml_torch.composite import StableHLOCompositeBuilder
  from litert_torch.odml_torch.composite.mark_tensor import serialize_composite_attr
  from litert_torch.odml_torch.composite.mark_tensor import mark_tensor_op
  from litert_torch.odml_torch.debuginfo import write_mlir_debuginfo_op
# isort: on
