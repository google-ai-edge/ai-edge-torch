...
from litert_torch.lowertools import translate_recipe
from litert_torch.odml_torch import export
...
def _wrap_as_tf_func(
  ...
  def inner(*args):
    ...
    # TODO(b/362798610) Build MLIR pybinding in litert-torch release.
